...
local module_key = "AHPrice"
local module_name = L["AH Price"]
local module_tooltip = L["Selected rule will only match items when compared to Auction value."]
...
function module.Widget:SetMatch(itemObj, Tooltip)
	if TSMAPI then
		module.CurrentMatch = TSMAPI:GetItemValue(itemObj.link, "DBMinBuyout")
	elseif Atr_GetAuctionBuyout then
		module.CurrentMatch = Atr_GetAuctionBuyout(itemObj.link)
	else
