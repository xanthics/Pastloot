...
local module = PastLoot:NewModule(L["Required Level"])
...
function module:CreateWidget()
  local DropDown = CreateFrame("Frame", "PastLoot_Frames_Widgets_RequiredLevelComparison", nil, "UIDropDownMenuTemplate")
  ...
  local DropDownEditBox = CreateFrame("EditBox", "PastLoot_Frames_Widgets_RequiredLevelDropDownEditBox")
