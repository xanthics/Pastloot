...
function module:CreateWidget()
  local frame_name = "PastLoot_Frames_Widgets_PlayerLevelComparison"
  local DropDown = PastLoot:CreateSimpleDropdown(self, module_name, frame_name, module_tooltip)

  local dropdownframe_name = "PastLoot_Frames_Widgets_PlayerLevelDropDownEditBox"
...
function module.Widget:DisplayWidget(Index)
  ...
  if (select(4, GetBuildInfo()) < 30000) then
    UIDropDownMenu_SetText(module:GetPlayerLevelText(Value_LogicalOperator, Value_Comparison), module.Widget)
  else
...
function module:DropDown_OnClick(Frame)
  ...
  if (select(4, GetBuildInfo()) < 30000) then
    UIDropDownMenu_SetText(self:GetPlayerLevelText(LogicalOperator, Comparison), Frame.owner)
  else
