...
L["Destroy"] = "Delete"
L["Destroy_Desc"] = "Will attempt to destroy an item if it matches this rule.  Check options for configuration on when items are deleted and what rarity requires confirmation."
...
L["Rolling is tried from left to right"] = "Rules are followed from right to left"
...
L["Will click yes on Destroy dialogues."] = "Will click yes on Delete dialogues."
...
L["DeleteImmediate"] = "Delete Immediately"
...
L["LearnWardrobe"] = "Learn Wardrobe Unlock"
L["LearnWardrobeDesc"] = "If the item being vendored or destroyed has a wardrobe unlock attempt to learn before selling or deleting."
L["Destroyed"] = true
L["Automatically Confirm Delete"] = true
L["Confirm Delete Desc"] = "Automatically confirm deleting items of the following rarities.  Grey items are always confirmed."
L["Can Bind"] = true
L["Selected rule will match whether an item can be bound to you."] = true
L["Cannot Bind"] = true
L["Is Bound"] = true
